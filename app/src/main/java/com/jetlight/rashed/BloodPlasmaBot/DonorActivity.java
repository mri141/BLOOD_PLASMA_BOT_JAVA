...
public class DonorActivity extends AppCompatActivity {
    ...
    String[] subtitle ={
            "2 miles","5 miles", "4 miles","7 miles", "8 miles",
            "2 miles","5 miles", "4 miles","7 miles", "8 miles",
            "2 miles","5 miles", "4 miles","7 miles", "8 miles",
            "2 miles","5 miles", "4 miles","7 miles", "8 miles",
    };
    ...
    public void CallHim(View view)
    {
        ...
        intent.setData(Uri.parse("Mobile No: 01521318070"));
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case DialogInterface.BUTTON_POSITIVE:
                            ...
                            Toast.makeText(DonorActivity.this, "You requested for AB+ blood type!",
